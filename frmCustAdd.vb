Public Class frmCustAdd
    'Declare global variable and set up path to the customers file
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        MsgBox("Customer details saved to file." & vbNewLine & "(At file position " & Val(txtCustID.Text) & ")")
